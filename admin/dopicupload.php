...
<li class="first"><a href="adminpass.php">My Password</a></li>
       ...
       <hr align="center" noshade="noshade" size="2" width="100%">
       <b style="color:#F00">Hints -- maximum upload size : 2mb</b><br/>
...
if(isset($_FILES['files'])){
	...
	if(empty($errors)){
		...
		$sql= mysqli_query($connect->connection,$query);
				  if($sql) {
		           echo "Product successfully created!<br/><br/><a href='createproduct.php'><<&nbsp;create product</a>";
