...
$pqy = mysqli_query($connect->connection, "SELECT COUNT(*) AS NumberOfProducts FROM products ORDER BY productID");
...
$query = mysqli_query($connect->connection, "SELECT * FROM products ORDER BY productID DESC LIMIT $start, $per_page");
